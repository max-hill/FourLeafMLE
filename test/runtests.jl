...
@testset "Is estimation accurate for random trees in the interior?" begin
    # The easy test
    test_result1 = [test_random_binary_quartet_model(:uniform) for i in 1:100]
    ...
    test_result2 = [test_random_binary_quartet_model(skewed_distribution) for i in 1:100]
    # Criterion for passing the second test: >99% success rate
...
@testset "Is estimation accurate for random trees on the boundary?" begin
    ...
    test_result5 = [test_random_zero_branch_model(skewed_distribution) for i in 1:100]
